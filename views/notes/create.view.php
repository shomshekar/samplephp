...
<main>
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    ...
    <form method="POST" class="block w-1/2" action="<?php echo $config['base_url'].'notes'?>">
